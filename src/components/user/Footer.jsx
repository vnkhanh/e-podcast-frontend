        ...
        <Row gutter={[32, 32]}>
          <Col xs={24} md={8}>
            <div className="footer-brand">
              <Title level={3} className="footer-logo">E-Podcast</Title>
              <Text className="footer-description">
                Nền tảng học tập trực tuyến hàng đầu Việt Nam, 
                mang đến trải nghiệm học tập qua podcast chất lượng cao.
              </Text>
          ...
          <Col xs={24} md={8}>
            <Title level={4} className="footer-title">Đăng ký nhận tin</Title>
